...
from crewai_visiontool.crew import CrewaiVisiontool
...
def run():
    ...
    if len(sys.argv) > 1:
        ...
        # Default to a sample image in current directory if not provided
        print("No image path provided. Using default 'sample_image.jpg'")
